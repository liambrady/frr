...
def ltemplatePreRouterStartHook():
    ...
    cmd='mkdir ~frr/.ssh ; if which certtool ; then {}; else if which openssl ; then {} ; fi ; fi; chown -R frr.frr ~frr/.ssh ; chmod -R go-rwx ~frr/.ssh ; ls -al ~frr/.ssh'.format(mk_c, mk_o)
